...
namespace MoGra
{
    public static class World
    {
        ...
        public const int ITEM_ID_AZAR_SWORD = 11;

        public const int MONSTER_ID_RAT = 1;
        public const int MONSTER_ID_SNAKE = 2;
        public const int MONSTER_ID_GIANT_SPIDER = 3;
        public const int MONSTER_ID_EVIL_LORD_AZAR = 4;

        public const int QUEST_ID_CLEAR_ALCHEMIST_GARDEN = 1;
        public const int QUEST_ID_CLEAR_FARMERS_FIELD = 2;
        public const int QUEST_ID_KILL_THE_EVIL_LORD = 3;
        ...
        public const int LOCATION_ID_LORD_CASTLE = 10;
        ...
        private static void PopulateItems()
        {
            ...
            _items.Add(new Item(ITEM_ID_AZAR_SWORD, "The lord sword", "Lord sword", UNSELLABLE_ITEM_PRICE));
        }
        ...
        private static void PopulateMonsters()
        {
            ...
            Monster azar = new Monster(MONSTER_ID_EVIL_LORD_AZAR, "The evil lord", 80, 10, 60, 15, 20);
            azar.LootTable.Add(new LootItem(ItemByID(ITEM_ID_AZAR_SWORD), 100, true));
        ...
        private static void PopulateQuests()
        {
            ...
            Quest killEvilLord =
                new Quest(
                    QUEST_ID_KILL_THE_EVIL_LORD,
                    "You must kill the evil lord Azar",
                    "Vanquish Azar in the castle", 40, 50);

            killEvilLord.QuestCompletionItems.Add(new QuestCompletionItem(ItemByID(ITEM_ID_AZAR_SWORD), 1));

            _quests.Add(clearAlchemistGarden);
            _quests.Add(clearFarmersField);
            _quests.Add(killEvilLord);
        }
        ...
        private static void PopulateLocations()
        {
            ...
            Location lordCastle = new Location(LOCATION_ID_LORD_CASTLE, "Castle", "You see a huge castle in front of you");
            lordCastle.AddMonster(MONSTER_ID_EVIL_LORD_AZAR, 200);
            lordCastle.QuestAvailableHere = QuestByID(QUEST_ID_KILL_THE_EVIL_LORD);
            ...
            alchemistsGarden.LocationToEast = lordCastle;
